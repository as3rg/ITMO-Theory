...
% $\us{g=\mcA^* f}{U^*} \os{\mcA^*}\lto \us f {V^*}$\\
...
\begin{enumerate}
    ...
    Решим систему $\left\{
        ...
        \end{array}
    \right.$\\
    $\det(L_kD_k) = d_1\ldots d_k \Rto \ex! y$\\
    $\det(D_kU_k) = d_1 \ldots d_k \Rto \ex! x$\\
    $d_{k+1} = a_{k+1,a_k+1} - xD_ky$
\end{enumerate}
