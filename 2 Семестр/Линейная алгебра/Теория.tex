...
Существуют координаты p-формы $f$ относительно базиса $\omega^{j_1}\land \ldots \land \omega^{j_p}m j_1<\ldots<j_p$\\
...
\textbf{Следствие 1}\\
$\fall \xi_1,\ldots,\xi_p \in V\ \omega^{j_1},\ldots,\omega^{j_p}(\xi_1,\ldots,\xi_p) = \begin{vmatrix}
...
$\{e_{i_1}\land \ldots \land e_{i_q}, i_1 < \ldots < i_q\}$ -- базис $\mc V^qV$\\
Пусть $p=q$\\
...
Пусть $g_{ij} = (e_i, e_j)$\\
$\Gamma = (g_{ij})$ -- матрица грамма базиса $e_1, \ldots, e_n$\\
...
$L = \span(a_1, \ldots, a_k), a$ -- базис\\
$\dist^2(x,L) = \frac{g(a_1, \ldots, a_k, x)}{g(a_,1 \ldots, a_k)}$\\
\textbf{Доказательство}\\
$\dist^2(x,L) = \|z\|^2$\\
$a_1, \ldots, a_k \leadsto b_1, \ldots, b_k$\\
$\span(a_1, \ldots, a_k) = \span(b_1, \ldots, b_k)$\\
