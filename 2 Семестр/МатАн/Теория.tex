...
Однако, отображение $\Rset^2 \rto \Rset^2$ -- вещественно дифференцируемое -- будет как отображение $\Cset\rto \Cset$ комплексно дифференцируемымЭ если матрица $L$ имеет вид $\begin{pmatrix}
    a & -b\\
    b & a
\end{pmatrix}$\\
\textbf{Утверждение}\\
